...
public class Bet24 extends Sajt
{
    private final int MAX = 1000;
    private final File  LOKALFIL = new File("bet24.txt"); 
    private URL url;
    private final int SAJTNR = 2;
    private int antal = 0;
    private final String name = "Bet24";
    private Betcalc betcalc;
    private String deli = "";
    
    
    public Bet24(Betcalc betcalc)
    {
